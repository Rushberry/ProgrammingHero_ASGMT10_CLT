...
const Footer = () => {
    ...
    return (
        <div className="mx-auto flex flex-col justify-center items-center w-full bg-black py-[70px]">
            <img src="/assets/favicon.png" className="w-[160px]" alt="Chill Gamer" />
            <p className="font-medium text-[16px] text-red-900 w-[75%] text-center mt-3">Discover games, share reviews, and chill with fellow gamers—all in one place!</p>
            ...
            <p className="font-medium text-[16px] text-red-900 w-full text-center mt-5">&copy; {currentYear}. All Rights Reserved. </p>
        </div>
    );
};
