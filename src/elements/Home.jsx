...
const Home = () => {
    ...
    useEffect(() => {
        ...
        fetch('https://chill-gamer-server-virid.vercel.app/adventure')
            .then(res => res.json())
            .then(data => setAdventure(data))
        fetch('https://chill-gamer-server-virid.vercel.app/rpg')
            .then(res => res.json())
            .then(data => setRPG(data))
        fetch('https://chill-gamer-server-virid.vercel.app/action')
            .then(res => res.json())
    ...
    return (
        <div className={`flex flex-col -z-20 justify-center items-center py-12 ${background} bg-no-repeat bg-cover border-b border-red-900`}>
            <h1 className={`${boldText} lg:text-3xl md:text-2xl text-lg mb-3`}>
                <Typewriter
