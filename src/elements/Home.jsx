    ...
    return (
        <div className="flex flex-col justify-center items-center py-12 bg-[url('/assets/bg.jpg')] bg-no-repeat bg-cover border-b border-red-900">
            ...
            <div className="flex flex-col justify-start items-start text-left w-11/12">
                <h1 className="font-old lg:text-3xl md:text-xl text-lg text-white mt-12 text-left">Highest Rated Games</h1>
                ...
                <h1 className="font-old lg:text-3xl md:text-xl text-lg text-white mt-12 text-left">Latest Releases</h1>
                <div className="grid grid-cols-3 gap-7 mt-7">
                    {
                ...
                <h1 className="font-old lg:text-3xl md:text-xl text-lg text-white mt-12 text-left">Explore by Genre</h1>
                <h3 className="lg:text-xl md:text-lg text-md text-white mt-5 text-left">• Adventure:</h3>
                <div className="grid grid-cols-3 gap-7 mt-7">
                    {
                ...
                <h3 className="lg:text-xl md:text-lg text-md text-white mt-5 text-left">• Action:</h3>
                <div className="grid grid-cols-3 gap-7 mt-7">
                    {
                ...
                <h3 className="lg:text-xl md:text-lg text-md text-white mt-5 text-left">• RPG:</h3>
                <div className="grid grid-cols-3 gap-7 mt-7">
                    {
